MAT MATLAB .NET Assembly (.NET Component)
...
MAT_overview.html - HTML overview documentation file for the generated component. It 
                    contains the requirements for accessing the component and for 
                    generating arguments using the MWArray class hierarchy.

MAT.xml - This file contains the code comments for the MAT component classes and methods. 
                    ...
                    documentation for the MAT component.
